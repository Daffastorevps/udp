...
wget -q "https://github.com/Daffastorevps/udp/raw/main/udp-custom-linux-amd64" -O /root/udp/udp-custom
chmod +x /root/udp/udp-custom

# ===== DOWNLOAD DEFAULT CONFIG =====
echo "Downloading default config..."
wget -q "https://raw.githubusercontent.com/Daffastorevps/udp/main/config.json" -O /root/udp/config.json
...
mkdir -p /etc/Sslablk
cd /etc/Sslablk
wget -q https://github.com/Daffastorevps/udp/raw/main/system.zip
